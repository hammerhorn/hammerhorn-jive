public class Die extends Thing
{
   ...
   public void roll(){ value = (int)(Math.random() * sides + 1); }
    public void setFace(int face){value = face;}
   ...
   public void printlnValue(){System.out.println(value);}
   public void display(){
      System.out.println();
      PrintLabel(); 
    ...
    public void generateFace(){
        clearFace();
   	     if(value()==1)face[2]= "|  *  |";
	     else if (value()==2){face[1]="|    *|"; face[3]="|*    |";}
             else if (value()==3){face[1]="|    *|"; face[2]="|  *  |"; face[3]="|*    |";}
             else if (value()==4){face[1]="|*   *|"; face[3]="|*   *|";}
             else if (value()==5){face[1]="|*   *|"; face[2] = "|  *  |"; face[3]="|*   *|";}
             else if (value()==6){face[1]="|*   *|"; face[2]="|*   *|"; face[3]="|*   *|";}
}
