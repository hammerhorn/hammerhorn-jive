...
public class Note extends Wave{
	...
	else if (s.equals("C#") || s.equals("c#") || s.equals("Db") || s.equals("db")) {  note_float = 4; 
           notename = "C♯/D♭"; }
	...
	else if (s.equals("D#") || s.equals("d#") || s.equals("Eb")  || s.equals("eb")){  note_float = 6; 
           notename = "D♯/E♭"; }

	else if (s.equals("E") || s.equals("e") || s.equals("Fb") || s.equals("fb"))   {  note_float = 7; 
           notename = "E"; }

	else if (s.equals("E#") || s.equals("e#") || s.equals("F") || s.equals("f"))   {  note_float = 8; 
           notename ="F"; }
